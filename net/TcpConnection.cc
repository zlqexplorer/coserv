...
#include "coserv/base/WeakCallback.h"
#include "coserv/net/Channel.h"
#include "coserv/net/EventLoop.h"
#include "coserv/net/Socket.h"
...
void coserv::net::defaultConnectionCallback(const TcpConnectionPtr& conn)
{
...
void coserv::net::defaultMessageCallback(const TcpConnectionPtr&,
                                        Buffer* buf,
                                        Timestamp)
{
  buf->retrieveAll();
